...
The 9.63 kg allocation is no longer presented as the current dynamics mass. A reproducible reconciliation now combines 66 fabrication-CAD parts, 25 published actuator masses and 142 joint-hardware density-screen solids. The gross identified subtotal is 8.693 kg, and the conservative per-link reconciled dynamics model is 13.227 kg with neutral COM Z=0.331 m. Major electrical, compute, sensor, harness, fastener, cooling, sole, restraint and battery masses remain unmodeled, so the -3.227 kg arithmetic margin to the 10 kg maximum is not closure evidence.
