...
def write_registers() -> None:
    selections = [
        ...
        {"selection_id": "FH-S04", "assembly": "PCB pedestal", "quantity": 16, "candidate": "SABIC LEXAN 9034 clear polycarbonate", "order_code": "PROJECT PART E1-PED-6X3", "defined_geometry": "dia6.0 x 3.0 mm ring; dia2.8 clearance", "disposition": "CNC/WATERJET FROM 3.0 MM SHEET; RECEIVED FIT REQUIRED", "built": "NO", "warning": WARNING},
        {"selection_id": "FH-S05", "assembly": "PCB standoff", "quantity": 16, "candidate": "Wuerth Elektronik WA-SPAII plastic internal/internal spacer", "order_code": "970080155", "defined_geometry": "5 mm AF; 8.0 +/-0.1 mm; M2.5 both ends; black PA", "disposition": "EXACT CANDIDATE; AVAILABILITY AND RECEIVED THREAD FIT REQUIRED", "built": "NO", "warning": WARNING},
        {"selection_id": "FH-S06", "assembly": "PCB top screw", "quantity": 16, "candidate": "Essentra nylon crossed pan screw", "order_code": "50M025045P006 / ITEM 10295533", "defined_geometry": "M2.5 x 0.45; 6.0 mm; head dia5.0 x 1.6 mm", "disposition": "EXACT CANDIDATE; TORQUE/ENGAGEMENT PROCESS OPEN", "built": "NO", "warning": WARNING},
        {"selection_id": "FH-S07", "assembly": "PCB bottom screw", "quantity": 16, "candidate": "Essentra nylon slotted cheese screw", "order_code": "50M025045D012 / ITEM 10325643", "defined_geometry": "M2.5 x 0.45; 12.0 mm; project envelope head dia4.5 x 1.6 mm", "disposition": "EXACT CANDIDATE; 3.0 MM MINIMUM NOMINAL ENGAGEMENT; TORQUE OPEN", "built": "NO", "warning": WARNING},
    ...
    inspection = [
        ...
        ("FH-I03", "all panel holes and slots", "4 foot +16 PCB +8 cover holes and four slots present; no burr/chip", "CMM + visual"),
        ...
        ("FH-I06", "PCB support stack", "16 pedestals +16 order-code 970080155; board plane 14.0 mm nominal Z", "height gauge + label trace"),
...
def update_fixture_records() -> None:
    ...
    replacement = [
        ...
        {"item": "E1-03", "quantity": 16, "part": "M2.5 PCB pedestal + standoff", "candidate": "PROJECT E1-PED-6X3 + WUERTH 970080155", "fabrication": "CNC PEDESTAL + PURCHASE STANDOFF", "release": "NO", "warning": old[0]["warning"]},
        {"item": "E1-04", "quantity": 16, "part": "M2.5 top/bottom screw pair", "candidate": "50M025045P006 + 50M025045D012", "fabrication": "PURCHASE; TORQUE/FIT PROCESS OPEN", "release": "NO", "warning": old[0]["warning"]},
...
def generate_into_fixture() -> dict:
    ...
    return {"hardware_selection_count": 13, "pcb_stack_count": 16, "cover_stack_count": 8, "foot_stack_count": 4}
