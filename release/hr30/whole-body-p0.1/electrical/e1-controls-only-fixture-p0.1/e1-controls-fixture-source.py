...
def write_cad(exported: dict[str, Path]) -> dict:
    ...
    underside_raceway = (
        cq.Workplane("XY").box(245, 34, 3)
        .translate((-15, 0, -8.5)).val()
    )
    feet = [
    ...
    assembly.add(underside_raceway, name="UNDER_PANEL_LOGIC_CABLE_COVER", color=cq.Color(0.05, 0.22, 0.42, 1))
