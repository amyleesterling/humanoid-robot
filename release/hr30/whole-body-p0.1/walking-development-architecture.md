...
The whole body has six commanded axes per leg: hip yaw/roll/pitch, knee pitch, and ankle pitch/roll. Hip pitch reserves 1.5:1, knee and roll axes reserve 2.0:1, and ankle pitch reserves 2.5:1 timing reductions with dual-supported 12 mm outputs and output encoders. Each foot is 90 x 145 mm with four-corner force sensing and a replaceable compliant sole. The active tether-first planning dynamics mass is 10.470 kg with neutral COM Z=0.346 m; these are candidate-volume and allocation values, not measured properties. The separate 11.936 kg onboard-envelope case retains rejected-pack packaging evidence and is not an active power configuration.
