...
This package converts the active 9.831 kg tether-first whole-body model into two complete 50 Hz minimum-jerk step candidates. Each sequence begins in neutral double support, crouches, transfers weight, lifts one foot, reaches a 40 mm capture-step target and ends in a nominally flat double-support touchdown. All 25 joint positions, velocities and accelerations are present at every sample, and the exact keyframes are loadable in the tether MJCF model.
