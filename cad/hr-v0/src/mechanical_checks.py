    ...
    results = {
        ...
        "inputs": {
            ...
            "selected_interfaces": {
                ...
                "distal_gripper": "FR12-H104K selected four-hole subset on 24 x 12 mm rectangle; physical fit required",
            },
        ...
        "not_credited_or_unresolved": [
            ...
            "Physical FC01/FC02/FC03 pattern verification, received thread depth and stack tolerance",
