...
Two hundred ten review/control rounds are complete: R01-R210. R11 Fable and R12 Sol are independent parallel reviews of the same pre-correction baseline. The resupplied Sol verdict is the same R12 analysis and is not double-counted. R13-R210 are project-owned correction, evidence-control or validation passes, not additional independent approvals. R195-R207 add the current watchdog/runtime/observation source chain. R208 exposes the 1.00 kohm RSO hard-short blocker. R209 introduces four separately limited `SN74LVC1G125DBVR` channels but is superseded because its project-owned DBV lands do not match TI 4214839/K and its GPIO short screen has negligible temperature margin. R210/P0.4 corrects both defects and passes native ERC/DRC, but Pi 5/RP1 DC acceptance, installed timing, partial-power tests, manufacturing, physical evidence, qualified review and work authority remain open.
...
- [R210 current source-audited observation-carrier guide](release/hr-v0/runtime-observation-carrier-p0.4/index.html)
- [R210 native schematic, routed PCB and controlled schedules](electrical/kicad/hr-v0-runtime-observation-carrier-p0.4/)
...
| R210 | Source-audited buffered observation-carrier correction | Issued `HR-V0-RUNTIME-OBS-CARRIER-P0.4`; corrected every DBV land to 1.10 x 0.60 mm on 2.60 mm row spacing, replaced the GPIO limiter with exact Panasonic 39.0 kohm, and included tolerance plus +/-100 ppm/K temperature allowance. The 2.449 mA ISO-side, 94.18 uA GPIO-side, 2.516 V buffer-input, 2.582 V cable-side and 6.183 mA steady-load figures are analytical screens. Native ERC/DRC and the dedicated checker pass; fourteen physical/application/review holds remain and no work authority exists. |
