...
def holds() -> list[dict[str, object]]:
    data = [
        ...
        ("IAD-H09", "the eight carrier-to-first-actuator harnesses are controlled by the separate carrier-first-axis package but remain unbuilt and unvalidated", "complete that package's conductor, star-landing, routing, continuity, waveform and qualified-review evidence"),
