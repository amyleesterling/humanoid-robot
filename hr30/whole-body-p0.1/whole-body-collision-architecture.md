...
|---|---:|---:|---:|---|
| Neutral double support | 290 | 0 | 8.00 mm | `R_upper_arm::base_link` |
| Crouched double support | 290 | 0 | 8.00 mm | `R_upper_arm::base_link` |
| Left weight transfer | 290 | 0 | 23.67 mm | `L_forearm::L_gripper` |
| Right foot lift | 290 | 0 | 23.67 mm | `L_forearm::L_gripper` |
| Right capture-step candidate | 290 | 0 | 7.33 mm | `R_upper_arm::base_link` |
| Right weight transfer | 290 | 0 | 23.67 mm | `L_forearm::L_gripper` |
| Left foot lift | 290 | 0 | 23.67 mm | `L_forearm::L_gripper` |
| Left capture-step candidate | 290 | 0 | 7.31 mm | `R_upper_arm::base_link` |
