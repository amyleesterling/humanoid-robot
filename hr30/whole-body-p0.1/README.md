...
The former empty torso, pelvis, head and foot reservations now contain 53 located equipment, harness, contact, sole and installation-hardware candidates with explicit mounting planes, service directions, connector boundaries and dynamic-link placement. Their provisional as-installed planning mass is 2.023 kg. The assembly is tether-first: the offboard current-limited source and safety relay are intentionally not counted as onboard mass, while the robot carries a keyed inlet, dual interruption candidate, branch distribution, conversion and telemetry envelopes. Exact selections, ratings, pinouts, cable construction, thermal tests and safety validation remain open.

## Whole-body mass reconciliation

The 9.63 kg allocation is no longer presented as the current dynamics mass. A reproducible reconciliation now combines 66 fabrication-CAD parts, 25 published actuator masses, 142 joint-hardware candidate parts (including catalogue bearing masses), 10 catalogue belt candidates and 53 located equipment/harness/contact items. The tether-first gross identified subtotal is 9.252 kg; the explicit per-link model plus 8% integration contingency is 9.993 kg with neutral COM Z=0.347 m. The onboard battery/BMS/charger is not installed, and exact selections/received masses remain open.
