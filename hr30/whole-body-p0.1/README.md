...
The 9.63 kg allocation is no longer presented as the current dynamics mass. A reproducible reconciliation now combines 66 fabrication-CAD parts, 25 published actuator masses, 142 joint-hardware density-screen solids and 53 located equipment/harness/contact items. The tether-first gross identified subtotal is 10.716 kg; the explicit per-link model plus 8% integration contingency is 11.573 kg with neutral COM Z=0.342 m. The onboard battery/BMS/charger is not installed, and exact selections/received masses remain open.
