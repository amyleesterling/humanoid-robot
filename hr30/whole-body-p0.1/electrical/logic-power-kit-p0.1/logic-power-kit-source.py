...
def sources() -> list[dict[str, object]]:
    return [
        ...
        common({"source_id": "LP-S06", "manufacturer": "Alpha Wire", "document": "FIT-KIT-221BK product specification", "revision_or_date": "live manufacturer specification; revision/date not stated", "accessed": DATE, "url": "https://www.alphawire.com/disteAPI/SpecPDF/DownloadProductSpecPdf?productPartNumber=FIT-KIT-221BK", "verified_use": "kit includes black FIT-221-1/4 2:1 cross-linked polyolefin sleeve; 6.35 mm supplied and 3.175 mm recovered ID"}),
        common({"source_id": "LP-S07", "manufacturer": "Brady", "document": "M21-11-427 product page", "revision_or_date": "live manufacturer page; revision/date not stated", "accessed": DATE, "url": "https://www.bradyid.com/wire-cable-labels/self-laminating-vinyl-wrap-around-labels-ribbon-pre-sized-for-m210-m211-printers-cps-4293071?part-number=m21-11-427", "verified_use": "0.75 x 0.5 in B-427 self-laminating label; published wire-diameter range includes Alpha 3051"}),
    ]
...
def equipment() -> list[dict[str, object]]:
    data = [
        ...
        ("LP-P08", "black 2:1 heat-shrink sleeve kit", "Alpha Wire", "FIT-KIT-221BK", 1, "EXACT MATERIAL CANDIDATE - CUT LENGTH AND PROCESS OPEN"),
        ("LP-P09", "self-laminating wire labels", "Brady", "M21-11-427", 4, "EXACT MATERIAL CANDIDATE - PRINT, PLACEMENT AND RETENTION OPEN"),
    ]
...
def main() -> int:
    ...
    status = {
        ...
        "exact_sleeve_and_label_material_candidates_selected": True,
