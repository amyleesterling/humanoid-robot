...
The whole body has six commanded axes per leg: hip yaw/roll/pitch, knee pitch, and ankle pitch/roll. Hip pitch reserves 1.5:1, knee and roll axes reserve 2.0:1, and ankle pitch reserves 2.5:1 timing reductions with dual-supported 12 mm outputs and output encoders. Each foot is 90 x 145 mm with four-corner force sensing and a replaceable compliant sole. The active tether-first planning dynamics mass is 9.928 kg with neutral COM Z=0.349 m; these are candidate-volume and allocation values, not measured properties. The separate 11.394 kg onboard-envelope case retains rejected-pack packaging evidence and is not an active power configuration.
...
|---|---:|---|---:|---:|---:|
| Neutral double support | S2 | DOUBLE | 44.8 mm | 0.0 mm | 0.0 mm |
| Crouched double support | S2 | DOUBLE | 47.2 mm | 0.0 mm | 0.0 mm |
| Left weight transfer | S3 | DOUBLE | 22.3 mm | 0.0 mm | 0.0 mm |
| Right foot lift | S4 | L SINGLE | 22.4 mm | 6.8 mm | 1.0 mm |
| Right capture-step candidate | S5 | L SINGLE | 22.7 mm | 17.2 mm | 40.7 mm |
| Right 40 mm touchdown | S5 | DOUBLE | 64.8 mm | 0.0 mm | 40.0 mm |
| Right weight transfer | S3 | DOUBLE | 23.5 mm | 0.0 mm | 0.0 mm |
| Left foot lift | S4 | R SINGLE | 23.6 mm | 6.8 mm | 1.0 mm |
| Left capture-step candidate | S5 | R SINGLE | 23.9 mm | 17.2 mm | 40.7 mm |
| Left 40 mm touchdown | S5 | DOUBLE | 64.8 mm | 0.0 mm | 40.0 mm |
