# Project Button HR-V0 Electrical V3-P1.17-OBSERVATION-P0.5-CANDIDATE
...
13. `13_runtime_observation_system.kicad_sch` — Runtime diagnostic observation interfaces
...
Run the R212 observation-candidate generator with `--validate` with KiCad 10 installed. Generated ERC proves only modeled connectivity/annotation. Every `TBD-*`, `SELECTION REQUIRED`, `DESIGN REQUIRED`, and application-confirmation item remains a release blocker.
