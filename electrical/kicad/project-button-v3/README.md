# Project Button HR-V0 Electrical V3-P1.14
...
- `project-button-v3.kicad_pcb` is the native PCB-P0.8 routed/test-access candidate. It is geometry/topology-identical to PCB-P0.7 and adds 36 hidden native manufacturer/package/document/process-state fields for UDRV1/UDRV2/UFB1/ISO1. It retains the R89 manufacturer-traced lands and exact rectangular 3.45 x 1.85 mm Harwin issue-10 test-point copper; field/control zoning and separate TI-recommended 2 mm x 2 mm SUB1/SUB2 floating copper planes remain. It encodes a 0.1524 mm minimum trace/clearance. Assembly process remains SELECTION REQUIRED. It is not a Gerber or fabrication release; supplier acceptance, installed probe access, protection coordination, schematic parity review, creepage/clearance, thermal, EMC and HIL evidence remain gates.
