# HR-V0 DYNAMIXEL star injection DXL-STAR-P0.2-CARRIER-CANDIDATE
...
- `JP1`-`JP3` are JST `B2P-VH` post-limiter branch inputs; project pin 1 is VDD and pin 2 return.
- `JA1`-`JA3` are JST `B3B-EH-A` actuator outputs using standard ROBOTIS TTL pin order.
- `J1_LIMITED_VDD`, `J2_LIMITED_VDD`, and `J3_LIMITED_VDD` are routed separately and never join.
