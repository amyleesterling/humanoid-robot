...
> **R97 OVERRIDING ARCHITECTURE/LOAD HOLD:** `HR-V0-ARM-ARCH-P0.7` remains the controlled unreleased geometry and its custom-metal route remains held. The nonselected P1.1 comparison preserves the R95 geometry and R96 incomplete load basis. `HR-V0-FR12-MASS-MET-P0.1` rejects contradictory storefront weight fields and defines an unpowered received-mass/COM/envelope/inertia-bound route for `LOAD-OPEN-01`; it contains zero executed physical results. The gripper, FR12 measured properties, hardware/harness, complete COM/inertia, drive/reflected inertia, bumper, continuous torque and measured dynamics remain unresolved. P1.0/P1.1 and X430 are unselected; P0.7 is not superseded and no purchase or external work is authorized.
