...
> **R94 OVERRIDING ARCHITECTURE HOLD:** `HR-V0-ARM-ARCH-P0.7` remains the controlled unreleased geometry and its custom-metal route remains held. `HR-V0-ARM-ARCH-P1.0-X430-CLEARANCE-CANDIDATE` relieves the P0.9 moving-striker edge, preserves nominal 118-degree stop contact and raises exact X430 clearance at that contact to 2.491516 mm. The <=1.491516 mm adverse-variation limit is unallocated; material, tolerance, fastener, received-fit, play, deformation, bumper, stopping and physical proof remain open. The 576.040 g incomplete subtotal is not a mass pass. P0.9/P1.0 are unselected, XM430 is not selected and P0.7 is not superseded.
