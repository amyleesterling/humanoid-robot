...
> **R95 OVERRIDING ARCHITECTURE HOLD:** `HR-V0-ARM-ARCH-P0.7` remains the controlled unreleased geometry and its custom-metal route remains held. `HR-V0-ARM-ARCH-P1.1-X430-LOWERED-FOREARM-CANDIDATE` shifts the member-side forearm subassembly 7 mm downward while preserving the J2 axis, FR12 pattern and nominal 118-degree external stop datum. Exact X430 clearance at contact becomes 4.369402 mm and nominal M5 countersink edge land becomes 4.300 mm. Six adverse-variation limits total 2.500 mm and arithmetically preserve a 1.500 mm residual plus 0.369402 mm margin, but every allocation remains unverified. Material, DFM/FAI, fasteners, received fit/runout/play, deformation, bumper, stopping and physical proof remain open. The 583.138 g incomplete subtotal is not a mass pass. P1.0/P1.1 and X430 are unselected; P0.7 is not superseded.
