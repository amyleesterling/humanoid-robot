...
> **R66 CURRENT BOUNDARY:** The historical P0.2 flat-arm architecture and R54/P0.1 through R57/P0.4 arm candidates remain superseded. `HR-V0-ARM-ARCH-P0.5` provides integrated A00-A07 geometry from the 40-4040 column through the H104, three custom-part drawing/DXF routes, exact candidate hardware, explicit transforms and a 40,001-pose two-axis collision screen. `HR-V0-MECH-P0.4` remains the release hold. No adapter, support, beam, fastener, motion limit or supplier packet is released.

**PRELIMINARY—NOT APPROVED FOR ENERGIZATION**

Status: correction-stage feasibility model. Exact vendor-coordinate arm source, explicit integrated transforms, an interactive candidate model, controlled C01/C04/C05 drawings/DXFs, preliminary mass properties, reproducible structural screens, controlled fit-coupon packages, a proposed orderable gripper mechanism allocation, a checked hard-stop load-case study, and a guard/catch/cable space study now exist. Received MTR/FAI, qualified analytical acceptance, T-slot capacity, received fastener stacks, torque/locking/reuse rules, physical coupon/kit inspection, complete mass closure, fabricable hard-stop parts, measured stopping/drop/sweep evidence, exact guard/receiver/harness parts, gripper force/fasteners, bench anchors, proof tests, and mechanical release are not complete. See [the R66 arm architecture candidate](hr-v0-arm-architecture-p0.5.md), [the P0.4 mechanical hold](hr-v0-mechanical-release-p0.4.md), [joint-interface basis](hr-v0-joint-interface-fasteners-p0.1.md), [gripper architecture](hr-v0-gripper-architecture-p0.1.md), [guard/receiver/cable architecture](hr-v0-guard-receiver-cable-p0.1.md), and [hard-stop basis](hr-v0-hard-stop-design-basis-p0.1.md).

## Current exact-coordinate candidate

R66 preserves the controlled XM540-to-S102 registration and parallel reference J1/J2 axes while adding the exact candidate column/support and H104 interfaces. J1 is at `(-210,81.025,500) mm` from A0. Candidate J1-to-J2 spacing is 202.550 mm; H104 G1 is 129.050 mm beyond J2 and 331.600 mm from J1, reserving 28.400 mm to the 360 mm object-center ceiling. The upper/forearm members are 100/50 mm vertical `20-2040` envelopes between candidate 9.525 mm C01/C04 adapters. A 40,001-pose, 0.5° J1/J2 screen finds first nominal adapter/body contact at J2=122°; 120° is therefore only a provisional software ceiling. Cables, hard-stop/stopping overtravel, continuous proof, guards, manufacturing variation and physical tolerances remain excluded.
