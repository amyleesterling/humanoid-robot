...
> **R96 OVERRIDING ARCHITECTURE/LOAD HOLD:** `HR-V0-ARM-ARCH-P0.7` remains the controlled unreleased geometry and its custom-metal route remains held. The nonselected P1.1 comparison preserves the R95 geometry and clearance results. `HR-V0-ARM-LOAD-P1.1-X430-CANDIDATE` adds a reproducible but incomplete moving-load basis: 143.485169 g is supported by exact nominal CAD/density or catalog-mass envelope evidence, while the 453.485169 g reference allocation includes 210 g gripper and 100 g payload point models. It is not an upper bound, continuous-torque proof, stop capacity or mass closure. The gripper, FR12, hardware/harness, complete COM/inertia, drive/reflected inertia, bumper and measured dynamics remain unresolved. P1.0/P1.1 and X430 are unselected; P0.7 is not superseded and no external work is authorized.
