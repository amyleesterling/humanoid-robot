...
> **R57 CURRENT BOUNDARY:** The historical P0.2 flat-arm architecture and R54/P0.1, R55/P0.2 and R56/P0.3 candidates remain withdrawn. `HR-V0-ARM-ARCH-P0.4` provides corrected XM540/S102 registration, vertical 20-2040 links, a controlled adapter drawing/DXF, exact material/fastener candidates, explicit transforms and a 221-pose collision screen, but `HR-V0-MECH-P0.3` remains the release hold. No adapter, beam, fastener, motion limit or supplier packet is released.

**PRELIMINARY—NOT APPROVED FOR ENERGIZATION**

Status: correction-stage feasibility model. Exact vendor-coordinate arm source, explicit replacement transforms, an interactive candidate model, controlled adapter drawing/DXF, preliminary mass properties, reproducible structural screens, three controlled fit-coupon packages, a proposed orderable gripper mechanism allocation, a checked hard-stop kinematic/load-case study, and a generated guard/catch/cable space study now exist. Received MTR/FAI, qualified analytical acceptance, received fastener stacks, torque/locking rules, physical coupon/kit inspection, complete mass closure, fabricable hard-stop parts, measured stopping/drop/sweep evidence, exact guard/receiver/harness parts, gripper force/fasteners, bench anchors, proof tests, and mechanical release are not complete. See [the R57 arm architecture candidate](hr-v0-arm-architecture-p0.4.md), [the R0.1 historical baseline](hr-v0-mechanical-r0.1.md), [joint-interface basis](hr-v0-joint-interface-fasteners-p0.1.md), [gripper architecture](hr-v0-gripper-architecture-p0.1.md), [guard/receiver/cable architecture](hr-v0-guard-receiver-cable-p0.1.md), [hard-stop basis](hr-v0-hard-stop-design-basis-p0.1.md), and [R11 engineering calculations](r11-engineering-calculations.md).

## Current exact-coordinate candidate

R57 preserves the controlled raw XM540-to-S102 registration while defining the adapter fabrication candidate and keeping the reference J1 and J2 axes parallel. Candidate J1-to-J2 spacing is 202.550 mm. The H104 gripper-frame origin is 129.050 mm beyond J2 and 331.600 mm from J1, reserving 28.400 mm to the 360 mm object-center ceiling. The upper/forearm members are 100/50 mm vertical `20-2040` conservative collision envelopes between candidate 9.525 mm adapters. A 221-pose, 0.5° screen from 15° through 125° finds first nominal adapter/body contact at 122°; 120° is therefore only a provisional software ceiling. Cables, hard-stop/stopping overtravel, continuous-between-sample proof, guards, base/column, gripper mechanism and physical tolerances remain excluded.
