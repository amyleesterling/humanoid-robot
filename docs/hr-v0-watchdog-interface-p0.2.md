...
Historical status: this R18 voltage-boundary correction is retained for traceability. Electrical V3-P1.0 and `docs/hr-v0-watchdog-feedback-p0.1.md` supersede the opaque `IFB1`/`IFB2` design placeholders with a calculated ISO1212DBQ candidate, exact heartbeat/driver/passive candidates, exact PCB-terminal candidates and an explicitly unrouted PCB-P0.1 source while retaining routing, stack-up, derating and physical-validation gates.
