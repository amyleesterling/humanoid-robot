...
The system BOM now contains 91 configuration groups: 17 evaluation candidates, 43 exact candidates on hold, three grouped-component holds, 21 selection-required groups, four exclusions and three integrated items. R163 binds `BOM-051` to the current DXL-STAR-P0.2 carrier-aware candidate and adds `BOM-087` through `BOM-091` for three P0.3 limiter-carrier PCBAs, six carrier harnesses, twelve exact held standoffs and twenty-four exact held screws. R164 binds BOM-051 to current quarantined `HR-V0-DXL-STAR-MFG-P0.2` internal CAM review. Provider/process/FAI, normalized XYRS, harness terminations/lengths, received fit, physical qualification and signed release remain open. None is a complete procurement, fabrication or application release.
