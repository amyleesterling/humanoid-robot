...
| HR-V0 mechanism | E1 | native quote geometry; separately modeled H101, S102 and selected FR12-H104K candidate interfaces; three hashed fit coupons; proposed orderable gripper parent kit and allocation; hard-stop coordinate, inertia and load-case study; 13-row moving-mass ledger with 565.4 g known and 184.6 g unresolved; unpowered/guarded validation procedures | received-part fit and kit records; released load-path CAD; exact gripper fasteners, guard and force limit; bearings, shafts, physical hard-stop parts and bumper data; cable paths, tolerances, measured mass/COM/effective inertia, proof/impact tests |
...
| Requirements and risk governance | E0 | 64 draft requirements; 40 open risks; traceability links | accountable owners, rationale, acceptance thresholds, evidence locations, approvers, change history, FMEA/FTA/common-cause review |
