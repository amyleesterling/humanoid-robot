...
| HR-V0 mechanism | E1 | `HR-V0-MECH-P0.6` integrated hold; `HR-V0-ARM-ARCH-P0.7` STEP/GLB/SVG/DXF candidate with A00-A07 plus HS-J2-POS, a 40,001-pose body sweep, 69-pair continuous body certificate, C06/C07 stop geometry, nominal 117.999985-degree metal contact, sensitivity/load screens and six stop controls; `HR-V0-HS-P0.3`; zero active fabrication packets | bumper selection/characterization; received MTR/FAI/fit; qualified load/contact/tolerance acceptance; T-slot and fastener proof; measured contact/stopping/backlash/compliance/uncertainty; cable/guard/as-built collision; J1/J2-negative stops; fatigue/impact proof; executed mass/COM/inertia and cycle evidence; qualified review |
