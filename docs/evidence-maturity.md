...
| HR-V0 mechanism | E1 | `HR-V0-MECH-P0.2` coordination candidate; 24 controlled parameters; 12 interfaces; 19 BOM-linked assembly groups; five exact candidate extrusion cuts; six-datum neutral assembly chain; corrected STEP/GLB transforms and anchor orientation; generated web-readable general arrangement; native DXF/STEP quote geometry; three hashed fit coupons; proposed gripper allocation; hard-stop/load study; guard/catch space envelope; five cable zones; 13-row moving-mass ledger | received-part fit and kit records; exact gussets/fasteners/anchors; supplier DFM/material certificates/FAI; released load-path CAD; measured stopping/drop/sweep envelope; exact guard/receiver/harness parts; gripper force limit; physical hard stops/bumper data; tolerances, measured mass/COM/inertia, proof/impact tests and qualified review |
...
| Requirements and risk governance | E0 | 71 draft requirements; 40 open risks; 91 procedure records; traceability links; controlled safety-allocation/FMEA/BOM/mechanical-release inputs | accountable owners, qualified PLr/SIL allocation, acceptance thresholds, executed evidence, approvers, change history, complete FMEA/FTA/common-cause review |
