...
| HR-V0 mechanism | E1 | `HR-V0-MECH-P0.3` correction hold; exact-source `HR-V0-ROBOTIS-IF-P0.1`; corrected `HR-V0-ARM-ARCH-P0.2` STEP/GLB/SVG candidate with explicit transforms, mathematical J1/J2 parallelism, a 221-pose 0.5-degree collision screen and candidate fastener/tool/load screens; zero active fabrication packets; base five-cut 1980 mm profile schedule; six frame-joint candidates under `HR-V0-FRAME-P0.2`; exact-bench survey/proof procedure | adapter pull-through/local-strength closure; exact M2.5 stack and received fit; continuous-between-sample collision proof; released hard stop and stopping-overtravel/uncertainty margin below first contact; cable/guard study; stress, slip, fatigue and impact proof; executed bench/frame-joint, FAI, mass/COM/inertia, guard/catch and cycle evidence; qualified review |
