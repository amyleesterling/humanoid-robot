...
| HR-V0 bill of materials | E1 | 72-group system BOM; complete closure classification; 16 exact evaluation-only candidate lines; 19 exact candidates on hold including S102 body frames, 20-2040 arm stock/end service, the base frame set, amber H1 and the Phoenix `3211861` FSR holder candidate; receiving quarantine routes | 29 selection-required groups plus grouped-component expansion; all six fuse links and Phoenix end cover; received evidence; exact harness/enclosure-application/guard/remaining-fastener/protection choices; signed hierarchical release BOM |
