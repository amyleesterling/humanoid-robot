...
| HR-V0 mechanism | E1 | `HR-V0-MECH-P0.4` integrated hold; exact-source `HR-V0-ROBOTIS-IF-P0.1`; `HR-V0-ARM-ARCH-P0.5` STEP/GLB/SVG/DXF candidate with A00-A07, explicit J1/J2/G1 transforms, mathematical parallelism, C01/C04/C05 drawing controls, exact candidate hardware, analytical screens and a 40,001-pose two-axis collision screen; zero active fabrication packets; base five-cut profile schedule; six frame-joint candidates; exact-bench survey/proof procedure | received MTR/FAI and fit; qualified calculation/allowable acceptance; T-slot pullout/slip/prying; complete received fastener stacks and torque/locking/reuse rules; continuous collision proof; released hard stop and stopping-overtravel/uncertainty margin below first contact; cable/guard study; fatigue/impact proof; executed bench/frame-joint, mass/COM/inertia, guard/catch and cycle evidence; qualified review |
