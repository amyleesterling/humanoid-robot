...
| HR-V0 mechanism | E1 | `HR-V0-MECH-P0.5` integrated hold; exact-source `HR-V0-ROBOTIS-IF-P0.1`; `HR-V0-ARM-ARCH-P0.6` STEP/GLB/SVG/DXF candidate with A00-A07, explicit J1/J2/G1 transforms, analytical screens, 40,001-pose sweep and continuous nominal certificate for 70 non-intentional rigid-body pairs through J2=120 degrees; `HR-V0-HS-P0.2` candidate 115/118/121.643289-degree allocation; zero active fabrication packets | received MTR/FAI and fit; qualified calculation/allowable acceptance; T-slot pullout/slip/prying; complete received fastener stacks and torque/locking/reuse rules; physical hard-stop CAD and measured stopping/backlash/compliance/tolerance/uncertainty closure; cable/guard/as-built collision study; fatigue/impact proof; executed bench/frame-joint, mass/COM/inertia, guard/catch and cycle evidence; qualified review |
...
| HR-V0 control implementation | E1 | canonical states; portable watchdog C candidate; executable supervisor, actuator-readback and fail-closed DYNAMIXEL transport models; mechanically bound 15–115° J2 command/raw-conversion envelope; 47 source tests; pinned SDK adapter and source manifest | accepted as-built hard-stop/stopping/calibration evidence hash; received actuator identities; external branch-current envelope; selected device path, kinematics, calibration, profiles and physical limits; target installation/execution; HIL, deadline, stale-data and reset-to-motion traces; qualified review |
