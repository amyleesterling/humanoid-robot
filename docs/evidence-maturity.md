...
| HR-V0 mechanism | E1 | `HR-V0-MECH-P0.2` coordination candidate; `HR-V0-FAB-RFQ-P0.1` seven-route supplier screen; three native zero-hole profile-blank STEP/DXF packages; 24 controlled parameters; 12 interfaces; 20 BOM-linked assembly groups; corrected five-cut 1980 mm profile schedule; six enumerated `40-4332`/`75-3422` frame joints under `HR-V0-FRAME-P0.2`; six controlled bracket ridges; analytic no-positive-volume member-overlap check; six-datum neutral assembly chain; corrected STEP/GLB transforms and anchor orientation; generated web-readable general arrangement; native finished-part DXF/STEP quote geometry; three hashed fit coupons; proposed gripper allocation; hard-stop/load study; guard/catch space envelope; five cable zones; 13-row moving-mass ledger | received-part fit and kit records; bracket/gusset/tool access; actual frame-joint torque/slip/proof and qualified disposition; exact remaining fasteners/anchors; supplier written DFM and selection; material certificates/FAI; released load-path CAD; measured stopping/drop/sweep envelope; exact guard/receiver/harness parts; gripper force limit; physical hard stops/bumper data; tolerances, measured mass/COM/inertia, proof/impact tests and qualified review |
