...
| HR-V0 mechanism | E1 | `HR-V0-MECH-P0.3` correction hold; exact-source `HR-V0-ROBOTIS-IF-P0.1` same-origin STEP/SVG evidence; zero active fabrication packets; base five-cut 1980 mm profile schedule; six frame-joint candidates under `HR-V0-FRAME-P0.2`; exact-bench survey/proof procedure; 24 controlled parameters and 12 interfaces with the P0.2 arm chain visibly superseded | replacement exact-coordinate arm architecture; J1/J2 axis transform and parallelism proof; released link/gripper datums; collision/tool-access/cable study; load path, fasteners, tolerances and FAI; executed bench and frame-joint evidence; measured mass/COM/inertia, stops, guard/catch, proof/impact tests and qualified review |
