...
| HR-V0 bill of materials | E1 | 71-group system BOM; complete closure classification; 16 exact evaluation-only candidate lines; 17 exact candidates on hold including S102 body frames, 20-2040 arm stock/end service and the base frame set; receiving quarantine route | 30 selection-required groups including adapter release and exact structural fastener stacks; grouped-component expansion; received evidence; exact harness/enclosure/guard/remaining-fastener/protection choices; signed hierarchical release BOM |
...
| HR-V0 mechanism | E1 | `HR-V0-MECH-P0.3` correction hold; exact-source `HR-V0-ROBOTIS-IF-P0.1`; strengthened `HR-V0-ARM-ARCH-P0.3` STEP/GLB/SVG candidate with explicit transforms, mathematical J1/J2 parallelism, 9.525 mm nominal adapters, exact Westfield fastener candidates on hold, a 221-pose 0.5-degree collision screen and indicative static screens; zero active fabrication packets; base five-cut 1980 mm profile schedule; six frame-joint candidates under `HR-V0-FRAME-P0.2`; exact-bench survey/proof procedure | certified adapter material/minimum properties; accepted local conical-contact analysis; complete received fastener stacks and torque/locking rules; continuous-between-sample collision proof; released hard stop and stopping-overtravel/uncertainty margin below first contact; cable/guard study; stress, slip, fatigue and impact proof; executed bench/frame-joint, FAI, mass/COM/inertia, guard/catch and cycle evidence; qualified review |
...
| Requirements and risk governance | E0 | 75 draft requirements; 40 open risks; 95 procedure records; traceability links; controlled safety-allocation/FMEA/BOM/mechanical-release/frame-joint/bench-anchor/J2-limit inputs | accountable owners, qualified PLr/SIL allocation, acceptance thresholds, executed evidence, approvers, change history, complete FMEA/FTA/common-cause review |
