...
| HR-V0 bill of materials | E1 | 82-group system BOM; complete closure classification; 17 evaluation-only candidate lines including two S102 body-frame sets; seven-line/nine-article unpowered mechanical subset; 33 exact candidates on hold including the P0.6 enclosure/compute carrier/retention set and R122 USB2AC50CM host cable; receiving quarantine routes | program-owner purchase approvals; 24 selection-required groups plus grouped-component expansion; all six fuse links; received cable/U2D2/Pi-case identity and fit; complete SD1 conductor/fault/load-break/touch-protection/lockout/placement application; exact remaining harness/guard/fastener/protection choices; physical/electrical/EMC proof; signed hierarchical release BOM |
