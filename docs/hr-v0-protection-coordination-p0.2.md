# HR-V0 protection and conductor coordination P0.2

> **PRELIMINARY - NOT APPROVED FOR FABRICATION OR ENERGIZATION**

Date: 2026-08-06

Applies to: Electrical V3-P1.6, references `F0`, `F1`, `F2`, `F3`, `FSR1`, and `FSR2`

Status: input and evidence-control package only; physical values and execution evidence remain open

## Decision

No fuse ampere rating is released. R62 adds an exact non-LED DIN holder candidate for `FSR1` and `FSR2`, corrects the physically insufficient P0.1 panel reserve, and synchronizes the holder boundary with `HR-V0-CP-P0.2`. It does not select a fuse link, conductor, terminal accessory, splice, cable length, or released enclosure layout.
...
- `FSR1` and `FSR2`: proposed Phoenix Contact `PT 4-HESI (5X20)` item `3211861`, two non-LED DIN fuse-terminal holders. Phoenix publishes 5 x 20 mm fuse accommodation, a 6.3 A holder maximum, 500 V nominal voltage, 6.2 mm width, push-in connection, and converted 24-10 AWG range. These are holder limits only. The exact compatible end cover, fuse manufacturer/family, ampere rating, speed, voltage and interrupting rating, conductors, ferrules, grouping loss, and application remain `SELECTION REQUIRED`. The Schneider `LC1D25BD` coil's published 5.4 W value gives a nominal arithmetic screen of 0.225 A at 24 V; it does not establish pickup, transient, fault, or protective-device behavior.
...
| [Phoenix Contact PT 4-HESI (5X20), item 3211861](https://www.phoenixcontact.com/en-us/products/fuse-terminal-block-pt-4-hesi-5x20-3211861) | official US product page; generated product PDF dated 2026-07-06; rechecked 2026-08-07 | exact non-LED holder identity, 5 x 20 mm format, product limits, connection range and physical dimensions | fuse link, compatible end cover, conductor/ferrule selection, installed grouping/thermal result or application release |

## Release state

R62 keeps energization gate `EG-014` **partial**. The six-reference input register now freezes exact holder identities for all six references: `FHAC0002SXJ` for F0, `5025` for F1-F3, and two `3211861` terminals for FSR1/FSR2. It does not close the gate. All six fuse-link ratings/order codes, the fuse-terminal end cover, the two XM540 connector-limit conflicts, physical harness construction, fault current, operating current, thermal data, clearing proof, installation review, and qualified approval remain unresolved.
