...
| Mechanical | `HR-V0-MECH-P0.3` + `HR-V0-ARM-ARCH-P0.3` | Strengthened exact-coordinate arm candidate exists under the P0.3 hold; certified material, local analysis, received fastener stacks, torque/locking, continuous collision and stop/overtravel proof, FAI and qualified review remain open |
