...
| Electrical | `Project Button Electrical V3-P1.7` / `HR-V0-CP-P0.3` / `HR-V0-SD-P0.1` | connected schematic, dimension-screened panel allocation, and service-disconnect application screen; not released for wiring, drilling, fabrication, or energization |
