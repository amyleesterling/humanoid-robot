...
| Watchdog PCB | `PCB-P0.6` / `HR-V0-WD-LAND-P0.1` | routed land-corrected candidate; no current fabrication outputs; R88 PCB-P0.5 CAM superseded for current review |
