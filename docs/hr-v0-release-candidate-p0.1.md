...
| Electrical | `Project Button Electrical V3-P1.14` / `HR-V0-CP-P0.6` / `HR-V0-COMPUTE-INSTALL-P0.1` / `HR-V0-WD-SUPPLY-P0.1` / `HR-V0-SD-P0.2` / `HR-V0-24V-IF-P0.2` / `HR-V0-E2-HW-P0.2` / `HR-V0-COMPUTE-IF-P0.1` | connected schematic with direct S0 inputs and ordinary-relay `SR1:A1` supply gate, enlarged dimension-screened panel/compute allocation, exact held XT1/SD1/J24/Pi-case/U2D2-retention catalog candidates, exact factory 24 V source-cord mapping, frozen Pi heartbeat pin, no installed debug connector, separate unselected F24/USB-cable protection/interface and fail-closed E2 configuration slice; not released for wiring, drilling, cable/fixture construction, programming connection, lockout use, fabrication, connection, or energization |
| Watchdog PCB | `PCB-P0.7` / `HR-V0-WD-LAND-P0.1` / `HR-V0-WD-PCBA-RFI-P0.1` / `HR-V0-WD-PCBA-DATA-P0.1` | routed Harwin-shape-corrected candidate plus fail-closed assembler inquiry and internal exact-BOM/placement review data; no current CAM or assembler-normalized XYRS; PCB-P0.5 CAM and PCB-P0.6 superseded for current review |
