...
| Electrical | `Project Button Electrical V3-P1.13` / `HR-V0-CP-P0.5` / `HR-V0-WD-SUPPLY-P0.1` / `HR-V0-SD-P0.2` / `HR-V0-24V-IF-P0.2` / `HR-V0-E2-HW-P0.2` / `HR-V0-COMPUTE-IF-P0.1` | connected schematic with direct S0 inputs and ordinary-relay `SR1:A1` supply gate, dimension-screened panel allocation, exact held XT1/SD1/J24 catalog candidates, exact factory 24 V source-cord mapping, frozen Pi heartbeat pin, no installed debug connector, separate unselected F24 protection and fail-closed E2 configuration slice; not released for wiring, drilling, cable/fixture construction, programming connection, lockout use, fabrication, connection, or energization |
