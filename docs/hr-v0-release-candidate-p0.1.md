...
| Watchdog PCB | `PCB-P0.9` / `HR-V0-WD-IC-META-P0.1` / `HR-V0-WD-LAND-P0.1` / `HR-V0-WD-PCBA-RFI-P0.1` / `HR-V0-WD-PCBA-DATA-P0.2` / `HR-V0-WD-BOM-BIND-P0.1` | routed Harwin-shape-corrected candidate with all 42 exact identities in native KiCad fields plus current exact-BOM/placement/orientation review data; live `BOM-048` is hash-bound to the same PCB-P0.9/P0.2 identities; P0.8/P0.9 geometry/topology and P0.7/P0.9 assembly parity pass; no current CAM, supplier-normalized XYRS or process acceptance; PCB-P0.5 through P0.8 remain historical |
