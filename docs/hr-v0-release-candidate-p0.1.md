...
| Electrical | `Project Button Electrical V3-P1.15-CARRIER-CANDIDATE` / unaccepted `V3-P1.18-PANEL-TOPOLOGY-CANDIDATE` / `HR-V0-K1K2-APP-P0.3` / `V3-P1.17-OBSERVATION-P0.5-CANDIDATE` / `DXL-STAR-P0.2-CARRIER-CANDIDATE` / `HR-V0-DXL-PROT-CARRIER-P0.3` / `HR-V0-DXL-PROT-CARRIER-HARNESS-P0.1` / `HR-V0-DXL-CARRIER-INTEGRATION-P0.1` / `HR-V0-DXL-CARRIER-MOUNT-IF-P0.1` / `HR-V0-CONFIG-REC-P0.4` | P1.15 remains the direct watchdog/core binding; P1.18 is unaccepted but its 32 contactor-critical rows match P1.15 exactly. DC application suitability, protection, physical terminals/ratings, harness terminations/lengths, received fit, Pi acceptance, fault/thermal/EMC/stopping/endurance tests, independent acceptance and qualified review remain open; no wiring, drilling, fabrication, connection, motion or energization release |
