...
| Electrical | `Project Button Electrical V3-P1.14` / `HR-V0-DXL-PROT-EVAL-P0.1` / `HR-V0-CP-P0.6` / `HR-V0-COMPUTE-INSTALL-P0.1` / `HR-V0-WD-SUPPLY-P0.1` / `HR-V0-SD-P0.2` / `HR-V0-24V-IF-P0.2` / `HR-V0-E2-HW-P0.3` / `HR-V0-COMPUTE-IF-P0.1` / `HR-V0-ACT-AC-CORD-P0.1` | V3 remains the unchanged robot candidate; the separate five-sheet DXL protection evaluation models exact forward current-limiter and short-pulse shunt candidates but is not selected, PCB-released or inserted into V3/BOM; connected system schematic, panel/compute and exact held catalog candidates remain not released for wiring, drilling, cable/fixture construction, programming connection, lockout use, fabrication, connection, or energization |
...
| BOM / evaluation acquisition / receiving | `HR-V0-BOM-P0.1` / `EVALUATION-BATCH-A` / `HR-V0-EVAL-BATCH-A-ACQ-P0.1` / `HR-V0-EVAL-BATCH-A-RCV-P0.1` / `HR-V0-ACT-AC-CORD-P0.1` / `HR-V0-MECH-BOM-BIND-P0.1` / `HR-V0-DXL-STAR-MFG-P0.1` / `HR-V0-DXL-INJECT-BIND-P0.1` / `HR-V0-DXL-HARNESS-ALLOC-P0.1` | 17 evaluation lines / 21 units in four fail-closed lots; current known manufacturer-price floor $1,864.73 plus eight quote-required lines; 21 unit IDs, 252 unexecuted receiving records, 147 evidence placeholders and 21 quarantine labels; exact held North-American actuator-source AC cord, five-part P0.7 custom-metal set and source-bound DXL-star board; legacy three-module injection placeholder integrated into that single parent; three included branch cables integrated as BOM-086 while one custom controller cable remains unresolved; zero authorized, ordered or received; no complete-machine procurement release |
