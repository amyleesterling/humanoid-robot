...
| Electrical | `Project Button Electrical V3-P1.15-CARRIER-CANDIDATE` / `DXL-STAR-P0.2-CARRIER-CANDIDATE` / `HR-V0-DXL-PROT-CARRIER-P0.3` / `HR-V0-DXL-PROT-CARRIER-HARNESS-P0.1` / `HR-V0-DXL-CARRIER-INTEGRATION-P0.1` / `HR-V0-DXL-CARRIER-MOUNT-IF-P0.1` / `HR-V0-E2-P115-PARITY-P0.1` / `HR-V0-CONFIG-REC-P0.1` | Current carrier-aware connected candidate; native recorded ERC/DRC is 0/0 and the unchanged watchdog/E2 subset has exact P1.15 digital parity, but provider/process, physical terminals/ratings, harness terminations/lengths, received fit, fault/thermal/EMC tests, independent acceptance and qualified review remain open; no wiring, drilling, fabrication, connection, motion or energization release |
| Watchdog PCB | `PCB-P0.9` / `HR-V0-WD-IC-META-P0.1` / `HR-V0-WD-LAND-P0.1` / `HR-V0-WD-PCBA-RFI-P0.1` / `HR-V0-WD-PCBA-DATA-P0.2` / `HR-V0-WD-BOM-BIND-P0.1` / `HR-V0-WD-CAM-P0.1` / `HR-V0-E2-P115-PARITY-P0.1` | routed Harwin-shape-corrected candidate with all 42 exact identities in native KiCad fields plus exact BOM/placement/orientation data; current quarantined CAM review outputs contain ten Gerber/job and five drill/map/report files, IPC-D-356, native DRC 0 and exact 42-reference internal parity; its unchanged P1.15 system interfaces have exact digital parity; no supplier-normalized XYRS, provider/process acceptance, physical evidence, independent acceptance or work authorization; PCB-P0.5 through P0.8 remain historical |
...
| Firmware | `HR-V0-FW-P0.4` / `HR-V0-SUP-P0.3` / `HR-V0-ACT-P0.3` / `HR-V0-WD-BUILD-P0.2` / `HR-V0-DXL-TRANSPORT-P0.3` / `HR-V0-DXL-CURRENT-ENV-P0.1` / `HR-V0-LIMITS-P0.2` | source, P0.6/P0.7/P0.3 mechanically bound fail-closed transport boundary, current-envelope evidence binding, per-sample Current Limit/Goal Current drift faults and reproducible watchdog artifacts; calibration/accepted-current/limit evidence unresolved; SDK not installed on target; no received actuator configuration, connection, flash, execution or HIL validation |
| Functional safety | `HR-V0-FSA-P0.1` | allocation candidate; `DF-01` has zero safety credit; no PLr/SIL assigned |
| BOM / evaluation acquisition / receiving | `HR-V0-BOM-P0.1` / `EVALUATION-BATCH-A` / `HR-V0-EVAL-BATCH-A-ACQ-P0.1` / `HR-V0-EVAL-BATCH-A-RCV-P0.1` / `HR-V0-ACT-AC-CORD-P0.1` / `HR-V0-MECH-BOM-BIND-P0.1` / `DXL-STAR-P0.2-CARRIER-CANDIDATE` / `HR-V0-DXL-PROT-CARRIER-P0.3` / `HR-V0-DXL-PROT-CARRIER-HARNESS-P0.1` / `HR-V0-DXL-CARRIER-MOUNT-IF-P0.1` / `HR-V0-CONFIG-REC-P0.1` | 91 closure groups: 17 evaluation candidates, 43 exact holds, 3 grouped holds, 21 selection-required, 4 excluded and 3 integrated; carrier PCBAs, six harnesses and mounting hardware are represented but not procurement-released; current P0.2 CAM, provider/process/FAI, harness terminations/lengths, received fit and qualified acceptance remain open |
