...
| Electrical | `Project Button Electrical V3-P1.15-CARRIER-CANDIDATE` / `DXL-STAR-P0.2-CARRIER-CANDIDATE` / `HR-V0-DXL-PROT-CARRIER-P0.3` / `HR-V0-DXL-PROT-CARRIER-HARNESS-P0.1` / `HR-V0-DXL-CARRIER-INTEGRATION-P0.1` / `HR-V0-DXL-CARRIER-MOUNT-IF-P0.1` / `HR-V0-CONFIG-REC-P0.1` | Current carrier-aware connected candidate; native recorded ERC/DRC is 0/0, but P0.2 CAM, P1.15 watchdog/E2 parity, provider/process, physical terminals/ratings, harness terminations/lengths, received fit, fault/thermal/EMC tests and qualified review remain open; no wiring, drilling, fabrication, connection, motion or energization release |
...
| Actuator star PCB | `DXL-STAR-P0.2-CARRIER-CANDIDATE` | routed carrier-aware candidate; P0.1 CAM is historical and prohibited for P0.2; current manufacturing data remains `SELECTION REQUIRED` |
