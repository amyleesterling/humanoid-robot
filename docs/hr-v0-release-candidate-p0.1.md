...
| BOM / evaluation acquisition / receiving | `HR-V0-BOM-P0.1` / `EVALUATION-BATCH-A` / `HR-V0-EVAL-BATCH-A-ACQ-P0.1` / `HR-V0-EVAL-BATCH-A-RCV-P0.1` | 17 evaluation lines / 21 units in four fail-closed lots; current known manufacturer-price floor $1,864.73 plus eight quote-required lines; 21 unit IDs, 252 unexecuted receiving records, 147 evidence placeholders and 21 quarantine labels; zero authorized, ordered or received; no complete-machine procurement release |
