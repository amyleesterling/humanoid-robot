...
| Watchdog PCB | `PCB-P0.7` / `HR-V0-WD-LAND-P0.1` / `HR-V0-WD-PCBA-RFI-P0.1` | routed Harwin-shape-corrected candidate plus fail-closed assembler inquiry; no current fabrication outputs; PCB-P0.5 CAM and PCB-P0.6 superseded for current review |
