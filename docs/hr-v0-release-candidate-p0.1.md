...
| Electrical | `Project Button Electrical V3-P1.11` / `HR-V0-CP-P0.4` / `HR-V0-SD-P0.2` / `HR-V0-24V-IF-P0.2` / `HR-V0-E2-HW-P0.2` | connected schematic, dimension-screened panel allocation, exact held XT1/SD1/J24 catalog candidates, exact factory 24 V source-cord mapping, separate unselected F24 protection and fail-closed E2 configuration slice; not released for wiring, drilling, lockout use, fabrication, connection, or energization |
