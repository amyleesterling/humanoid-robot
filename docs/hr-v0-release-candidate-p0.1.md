...
| Mechanical | `HR-V0-MECH-P0.3` + `HR-V0-ARM-ARCH-P0.2` | Corrected exact-coordinate arm candidate exists under the P0.3 hold; adapter strength, exact fastener stacks, received fit, continuous collision and stop/overtravel proof, FAI and qualified review remain open |
