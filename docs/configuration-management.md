...
- **HR-V0-MECH-P0.2** identifies the current mechanical release-coordination candidate. Its native quote geometry remains **HR-V0-MECH-R0.1-PRELIMINARY**, its flat-plate process basis remains **HR-V0-PLATE-RFQ-P0.1**, and its exact catalog frame-joint candidate is **HR-V0-FRAME-P0.1**. P0.2 now binds one datum chain, 24 parameter records, 12 interface records, 20 assembly groups, five exact candidate extrusion cuts, six enumerated frame joints, a readable generated general arrangement and unexecuted inspection routes. It also removes misleading structural STL and corrects the assembly-space transforms and anchor orientation. Coupons, tolerances, actual-joint torque/slip/proof, remaining fasteners, stops, guard/catch, moving mass, cables, bench anchoring, first articles and qualified review remain open; P0.2 does not release a production part or assembly.
