...
- **HR-V0-MECH-P0.2** identifies the current mechanical release-coordination candidate. Its native quote geometry remains **HR-V0-MECH-R0.1-PRELIMINARY**, its flat-plate process basis remains **HR-V0-PLATE-RFQ-P0.1**, its fabrication-route supplement is **HR-V0-FAB-RFQ-P0.1**, its deterministic inquiry packets are **HR-V0-FAB-RFI-P0.1**, and its corrected exact catalog frame-joint candidate is **HR-V0-FRAME-P0.2**. P0.2 binds one datum chain, 24 parameter records, 12 interface records, 20 assembly groups, five exact candidate extrusion cuts, six enumerated frame joints, a readable generated general arrangement and unexecuted inspection routes. R49 corrects the frame topology; R50 controls one-stop and two-process routes; R51 adds bounded supplier inquiry packets and an exact-bench survey/proof evidence route; R52 canonicalizes controlled text packet payloads to LF and requires clean-clone validation plus zero-diff regeneration. Received fit/tool access, tolerances, actual-joint torque/slip/proof, remaining fasteners, stops, guard/catch, moving mass, cables, bench anchoring, supplier DFM, first articles and qualified review remain open; P0.2 does not release a production part or assembly.
