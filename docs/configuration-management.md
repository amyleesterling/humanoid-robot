...
- **HR-V0-MECH-P0.3** identifies the current mechanical correction hold. R53 uses exact manufacturer-coordinate ROBOTIS STEP files under **HR-V0-ROBOTIS-IF-P0.1**, withdraws the P0.2 J1/J2/G1 chain and `MV0-001` through `MV0-003`, and replaces **HR-V0-FAB-RFI-P0.1** with **HR-V0-FAB-RFI-P0.2-WITHDRAWN** containing zero supplier ZIPs. R54 adds **HR-V0-ARM-ARCH-P0.1** as a separate exact-coordinate candidate with explicit transforms, parallel-axis proof and a sampled self-collision screen; it does not supersede the P0.3 hold. The base cuts and **HR-V0-FRAME-P0.2** remain candidate coordination evidence. `MECH-005` / `AUDIT-MECH-012` still require exact profile/end-machining evidence, continuous collision/tool/cable studies, load path, fasteners, tolerances, FAI, physical proof and qualified disposition before any arm quotation or fabrication route can reactivate.
...
- **HR-V0-BOM-P0.1** identifies the 71-group system-BOM closure register and sixteen-line Evaluation Batch A boundary. R53 removes BOM-023 body frames from evaluation purchasing until the arm architecture is selected. The register exposes 32 selection-required groups and 15 exact candidates on hold; no received candidate is application-released by purchase or receipt.
