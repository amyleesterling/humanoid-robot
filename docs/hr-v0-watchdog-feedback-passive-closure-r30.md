...
| `CFI1`, `CFI2` | TDK `CGA3E2X7R1H103K080AA` | Production; 10 nF ±10%, 50 VDC, X7R, 0603, −55 to 125 °C, AEC-Q200 | Rated voltage exceeds the current 25.2 V screened rail maximum | Effective capacitance under DC bias, tolerance and temperature; received measurement; EMC placement and test |
| `RW1`, `RW2` | Vishay `CRCW12102K70FKEA` | 2.70 kΩ, ±1%, 1210; 0.5 W at 70 °C; 200 V maximum operating voltage | Current-source screen: worst steady loss 0.238 W, 47.6% of nominal rating | Board/enclosure temperature; power derating; pulse and open/short behavior; received resistance and thermal image |
