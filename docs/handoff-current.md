...
Mechanical package: **HR-V0-MECH-P0.5 integrated hold plus HR-V0-ARM-ARCH-P0.6 continuous nominal-clearance candidate and HR-V0-HS-P0.2 stop allocation; no physical stop, supplier packet, motion limit, or fabrication release**
Firmware package: **HR-V0-FW-P0.3 source/test candidate with supervisor P0.2, actuator P0.2 and DYNAMIXEL transport P0.2; J2 is bound to an unreleased 15–115° envelope; reproducible watchdog P0.2 artifacts; no installed target SDK, opened device, connected actuator, released or flashed binary**
...
- R66 issued `HR-V0-MECH-P0.4` and `HR-V0-ARM-ARCH-P0.5`, integrating exact candidate A00-A07 geometry from the 40-4040 column through the H104. R67 supersedes the current hold with `HR-V0-MECH-P0.5`, `HR-V0-ARM-ARCH-P0.6` and `HR-V0-HS-P0.2`; the part geometry remains unchanged.
- R67 continuously certifies all 70 non-intentional nominal rigid-body pairs through J2=120° with a required 0.75 mm floor and 0.765783 mm minimum conservative lower bound. Exact clearance at J2=120° is 0.962813 mm and numerical nominal contact is 121.643289°. The candidate J2 software/positive-stop datums are 115/118°, leaving separate 3° stopping and 2.643289° physical-uncertainty budgets. Those values are not released. Actual stop CAD, measured stopping, backlash/compliance/tolerance/uncertainty, cables/guard, T-slot proof, received stacks, proof, FAI and qualified review remain open.
- Candidate gravity screens remain 1.858/0.498 N·m and the proof-load candidate remains 12.5385 N·m. None is a released allowable, continuous-duty rating or physical proof result.
...
- R65 issued `HR-V0-FW-P0.2` and `HR-V0-DXL-TRANSPORT-P0.1`, pinning ROBOTIS DYNAMIXEL SDK 4.0.5 and adding torque-off-before-discovery, exact readback, authority-bound writes and fault-triggered torque removal. R68 supersedes the active boundary with `HR-V0-FW-P0.3`, `HR-V0-SUP-P0.2`, `HR-V0-ACT-P0.2` and `HR-V0-DXL-TRANSPORT-P0.2`; command screening and raw conversion now share the exact P0.5/P0.6/P0.2 mechanical identifiers and J2 15–115° envelope. The binding acceptance hash and all prior device, identity, calibration, profile, voltage/temperature and external-current selections remain unresolved. Nine HIL rows remain `NOT EXECUTED`; no hardware was connected.
...
Sixty-eight review/control rounds are complete and recorded in `docs/review-ledger.md`. R11 Fable and R12 Sol were commissioned independently against GitHub `main` at `ee276af...` before the R13/R14 corrections. R11 reported 7 BLOCKER, 11 MAJOR, and 12 MINOR findings. R12 reported 18 BLOCKER, 30 MAJOR, and 8 MINOR findings; the resupplied analysis is the same R12 verdict and is not double-counted. R13-R68 are controlled project responses, not independent approvals. R68 corrects the stale 125° firmware envelope and makes the 115° candidate fail closed pending physical evidence; it closes no physical gate and does not authorize quotation, fabrication, motion, connection or energization.

## Principal unresolved engineering blockers

1. HR-V0 has `HR-V0-ARM-ARCH-P0.6` under the `HR-V0-MECH-P0.5` hold. It supplies deterministic STEP/GLB/SVG/DXF, exact-source A00-A07 transforms, synchronized datum/interface tables, three custom-part drawing controls, exact stock/fastener candidates, a 40,001-pose sweep, continuous nominal rigid-body clearance evidence and analytical screens. It is not fabrication-ready: received MTR/FAI/fit, T-slot capacity, qualified calculation acceptance, torque/locking/reuse rules, cables/guard, physical hard-stop CAD, demonstrated stopping/backlash/compliance/tolerance/uncertainty closure, physical proof and qualified review remain open. The base frame still requires received-part fit, tool access, actual-joint torque, slip/proof, exact Boston bench anchors and qualified disposition. HR-30 has no released mechanical CAD.
...
9. `HR-V0-FW-P0.3` supplies a fail-closed source-level state machine, `HR-V0-SUP-P0.2`, `HR-V0-ACT-P0.2` register/readback rules and `HR-V0-DXL-TRANSPORT-P0.2`. The transport is pinned to official SDK 4.0.5; source tests cover ordered torque-off, discovery, configuration, authority, synchronous writes, faults and the exact 15–115° J2 boundary. Combined executable tests total 47. The committed configuration refuses to open a port because mechanical acceptance evidence and the prior device, identity, calibration, current, kinematic and timing inputs remain unresolved. Watchdog P0.2 remains unflashed. Raw 800/300 current values are guarded test candidates only. HR-30 still lacks its selected real-time implementation.
...
Use `docs/reviews/2026-08-07-mechanical-p0.6-independent-review-request.md` for the R67 exact-coordinate, continuous-clearance, candidate stop-allocation and current Sol R12 mechanical-blocker review scope.
