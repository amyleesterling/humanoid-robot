...
BOM package: **HR-V0-BOM-P0.1 closure candidate; 17 evaluation-only lines; 33 selection-required groups; no complete procurement release**
...
- 70 system BOM groups: 17 evaluation candidates, 12 exact candidates on hold, three grouped-component holds, 33 selection-required groups, four historical/DNP exclusions, and one integrated item
