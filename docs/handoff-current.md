...
Mechanical package: **HR-V0-MECH-P0.6 hold plus HR-V0-ARM-ARCH-P0.7 and HR-V0-HS-P0.3 / HR-V0-J2-STOP-P0.1; R70 adds a nonselected same-interface mass-reduction study, but no bumper, physical stop validation, accepted relieved part, supplier packet, motion limit, or fabrication release**
