...
Primary sources were checked 2026-08-05 through 2026-08-06: [ROBOTIS X-series connector definitions](https://emanual.robotis.com/docs/en/dxl/x/), [U2D2](https://emanual.robotis.com/docs/en/parts/interface/u2d2/), [U2D2 Power Hub](https://emanual.robotis.com/docs/en/parts/interface/u2d2_power_hub/), and the [IDEC XW candidate family page](https://www.idec.com/en-us/switches-indicator-lights/switches-pushbuttons/emergency-stop-switches/xw-22mm-estop/xw1e-bv402m-r). Live pages without a displayed document revision are access-dated and must be rechecked at release.
