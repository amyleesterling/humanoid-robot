...
| G-02 | Custom link/bearing geometry | R21 corrects the invalid symmetric PCD22 assumption and adds FC01/FC02 plus the expected frame-kit schedule; still requires physical coupon/receiving records, released gripper and hard stops, shaft/frame load calculation, exact fasteners, tolerance stack and proof | mechanical | fabrication |
