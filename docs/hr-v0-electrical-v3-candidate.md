...
Current superseding status: native connected design candidate `V3-P1.13`. P1.13 preserves P1.12's compute/debug correction, connects both S0 channels directly to SR1, and moves KWD1/KWD2 into a series gate on `SR1:A1`. See `docs/hr-v0-watchdog-supply-gate-p0.1.md`. The later long-form P1.12 paragraph is retained as its historical configuration record.
...
- 64 unresolved component/interface records; and
