# Project Button HR-V0 Electrical V3-P1.7 / PCB-P0.5 / DXL-STAR-P0.1 / HR-V0-CP-P0.3 / HR-V0-SD-P0.1 Independent Review Request

Review date: 2026-08-07
Controlled candidate: **Electrical V3-P1.7 / PCB-P0.5 / DXL-STAR-P0.1 / HR-V0-CP-P0.3 / HR-V0-SD-P0.1**
...
The authoritative source is this repository. The workshop website is presentation context only. Electrical V2.1 is the previously reviewed baseline; V3-P1.7 is a separate correction candidate and does not supersede it until its selections, calculations, tests, and qualified reviews close. Electrical P0.1 through P1.6 remain historical. P1.2 introduced `DXL-STAR-P0.1`; P1.3 retained the Schneider critical-current/application blocker; P1.4 added received-lot RESET/ARM terminal control; P1.5 froze exact amber H1 while preserving `TBD-HA/TBD-HB`; P1.6 froze the Phoenix `3211861` FSR1/FSR2 holder candidates; and P1.7 freezes only `D-ST 4` item `3030420` as the end-cover candidate. Both fuse links, received compatibility/grouping and all coordination remain unresolved. PCB-P0.5 and DXL-STAR-P0.1 are routed native candidates without fabrication outputs. HR-V0-CP-P0.3 retains the corrected larger Hammond allocation and releases no holes, cuts, wires, fuse links, protection values, bonds, cable entries or assembly. HR-V0-SD-P0.1 leaves SD1 `SELECTION REQUIRED`. Supplier archive acceptance, physical test access, source current-sharing, harness/protection, connector-current, contactor critical-current/application disposition, thermal/waveform/no-backfeed, COM-slew, brownout/EMC, received proof, physical terminals, panel depth/heat/duct-fill/bonding/human factors, HIL and functional-safety blockers remain open.
...
- R63 protection-coordination evidence: `docs/hr-v0-protection-coordination-p0.3.md`; `electrical/hr-v0-protection-coordination-inputs.csv`; `tests/forms/hr-v0-protection-coordination-template.csv`
...
- R63 control-panel and service-disconnect evidence: `docs/hr-v0-control-panel-p0.3.md`; `electrical/panel/hr-v0-control-panel-p0.3/`; `docs/hr-v0-service-disconnect-p0.1.md`; `tests/forms/hr-v0-control-panel-receiving-assembly-template.csv`; `tests/forms/hr-v0-service-disconnect-receiving-application-template.csv`
...
- HR-V0-CP-P0.3 with 24 panel-BOM rows, 20 nominal backplate allocations, five door rows, six exact XT1 positions, all 66 bounded V3 wire endpoints, six unreleased cable-entry zones, twelve thermal/space screens, 22 unexecuted panel rows plus 15 unexecuted SD1 rows, and no released hole/cut/wire/fuse/disconnect/protection/bond/entry/assembly value.
...
16. Audit HR-V0-CP-P0.3 against the physical devices and V3 source. Reproduce the P0.1 fit failure, then verify every P0.3 allocation, all 66 wire endpoints, cable-entry zones, H1 meaning, PCB envelopes, heat/loss/duty, duct fill, grounding/bonding, and every unexecuted evidence row. Independently verify Hammond `PJ242010RT` / `18P2117`, Phoenix `3211861` plus `3030420`, Blue Sea `5025`, and Littelfuse `FHAC0002SXJ`. Audit `HR-V0-SD-P0.1` and confirm Blue Sea `6004200` remains screening-only pending fault/load-break, conductor/lug, lockout, placement and jurisdiction evidence. Confirm that no fuse link, disconnect, drill, cut, conductor, termination, entry, PCB output, assembly or energization value is released.
