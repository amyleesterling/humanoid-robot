# HR-V0 protection and conductor coordination P0.3

> **PRELIMINARY - NOT APPROVED FOR FABRICATION OR ENERGIZATION**

Date: 2026-08-06

Applies to: Electrical V3-P1.7, references `F0`, `F1`, `F2`, `F3`, `FSR1`, and `FSR2`

Status: input and evidence-control package only; physical values and execution evidence remain open

## Decision

No fuse ampere rating is released. R63 retains the exact non-LED DIN holder candidates for `FSR1` and `FSR2`, freezes Phoenix Contact `D-ST 4` item `3030420` as the end-cover candidate, and synchronizes the accessory boundary with `HR-V0-CP-P0.3` and Electrical `V3-P1.7`. It does not select a fuse link, conductor, splice, cable length, service disconnect, or released enclosure layout.
...
R63 keeps energization gate `EG-014` **partial**. The six-reference input register now freezes exact holder identities for all six references: `FHAC0002SXJ` for F0, `5025` for F1-F3, and two `3211861` terminals plus one `3030420` end cover for FSR1/FSR2. It does not close the gate. All six fuse-link ratings/order codes, received end-cover compatibility/orientation, the two XM540 connector-limit conflicts, physical harness construction, fault current, operating current, thermal data, clearing proof, installation review, and qualified approval remain unresolved.
