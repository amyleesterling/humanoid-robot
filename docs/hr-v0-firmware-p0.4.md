...
Mechanical binding: `HR-V0-LIMITS-P0.2` / `HR-V0-ARM-ARCH-P0.8-DWG-INTEGRATED-CANDIDATE` / inherited kinematic basis `HR-V0-ARM-ARCH-P0.7` / `HR-V0-MECH-BOM-BIND-P0.3` / `HR-V0-HS-P0.3`

## R69 result

P0.4 preserves the candidate J2 engineering envelope of `15..115 deg` and updates every supervisor/actuator binding identifier to the current mechanical/stop package. R245 adds `HR-V0-FW-MECH-SRC-BIND-P0.1`, a SHA-256 binding to eight exact source evidence records. It does not accept the CAD or physical evidence automatically. The committed binding remains `CANDIDATE-NOT-RELEASED` and the separate acceptance-evidence hash remains `SELECTION REQUIRED`; selection closure therefore remains false and the transport refuses to open a serial port.
