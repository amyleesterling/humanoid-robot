...
The repository supervisor configuration deliberately retains unresolved configuration/kinematic hashes and start-pose tolerances, so it fails closed. Seventeen unit tests and a source-hash manifest are present. R31 retains the frozen Pico GPIO, exact heartbeat, two-package drivers and ISO1212DBQ feedback passives, and adds an explicitly unrouted PCB-P0.1 placement/interface source, but no compiled RP2040 platform binding, routed/released PCB, received/derating evidence, DYNAMIXEL transport, HIL trace or qualified code/safety review exists. See `docs/hr-v0-firmware-p0.1.md`, `docs/hr-v0-watchdog-feedback-p0.1.md`, `docs/hr-v0-heartbeat-driver-closure-r29.md`, `docs/hr-v0-watchdog-feedback-passive-closure-r30.md`, and `docs/hr-v0-watchdog-pcb-p0.1.md`. No safety credit is assigned to this implementation.
