...
def source_rows() -> list[dict[str, object]]:
    ...
    official = [
        ("ATB-S04", "Molex", "Micro-Fit 3.0 43020 series chart", "live official page; accessed 2026-08-17", "https://www.molex.com/en-us/products/series-chart/43020", "430200200 is a 2-circuit dual-row plug housing with panel-mount ears; exact fit/cutout not transcribed"),
        ("ATB-S05", "Molex", "430200200 official sales drawing", "current official PDF link; accessed 2026-08-17; revision/date not extracted", "https://www.molex.com/content/dam/molex/molex-dot-com/products/automated/en-us/salesdrawingpdf/430/43020/430200200_sd.pdf", "authoritative fit evidence required before bracket cutout release"),
...
def main() -> int:
    ...
    holds = [
        ...
        {"hold_id":"ATB-H02","unresolved":"zero received Micro-Fit connectors fitted to proxy or coupon","evidence_required":"received-lot inspection and fit coupon with latch/ear/access/tolerance record","state":"OPEN","authority":AUTHORITY,"warning":WARNING},
        {"hold_id":"ATB-H03","unresolved":"bracket material, process, inserts and fasteners unselected","evidence_required":"DFM, material lot, insert/fastener selection, torque/preload and environmental review","state":"OPEN","authority":AUTHORITY,"warning":WARNING},
    ...
    (OUT / "README.md").write_text(f"# HR-30 actuator transition brackets P0.1\n\n**{WARNING}**\n\nThis package supplies real editable part CAD and all 25 nominal placements. The connector window is a project-owned clearance proxy, not a released Molex cutout. Open `index.html` for the interactive guide.\n", encoding="utf-8", newline="\n")
