...
def main() -> int:
    ...
    require(9.80 < total_mass < 9.87 and "WITHIN MAXIMUM" in mass[-1]["status"], "active tether-first planning mass must remain below the 10 kg hard limit after the whole-body lightweight revision")
