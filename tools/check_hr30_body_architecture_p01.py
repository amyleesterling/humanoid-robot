...
def main() -> int:
    ...
    require(9.91 < total_mass < 9.95 and "WITHIN MAXIMUM" in mass[-1]["status"], "active tether-first planning mass must remain below the 10 kg hard limit after the three-rail auxiliary-power revision")
