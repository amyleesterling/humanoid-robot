...
def main() -> None:
    ...
    summary = {"identifier":IDENTIFIER,"date":"2026-08-08","status":"CONDITIONAL NONSELECTED STUDY - FAILS CURRENT 40 MM OBJECT MINIMUM","adapter_volume_mm3":round(volume_mm3,6),"adapter_mass_g":round(adapter_mass_g,6),"gripper_catalog_mass_g":30.0,"current_moving_subtotal_g":577.091,"remaining_arithmetic_headroom_g":round(remaining_g,6),"minimum_nominal_clearance_mm":0.3,"rear_nominal_gap_mm":0.5,"hold_count":12,"requirements_closed":0,"procurement_release":False,"fabrication_release":False,"assembly_release":False,"motion_release":False,"energization_release":False,"warning":WARNING}
