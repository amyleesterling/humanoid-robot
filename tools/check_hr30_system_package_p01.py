...
def main() -> int:
    ...
    require(status.get("energy_safety_spine_present") and status.get("direct_4s_lipo_architecture_rejected") and status.get("energy_safety_native_kicad_correction_required"), "energy/safety architecture integration missing")
