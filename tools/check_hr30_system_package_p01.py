...
def main() -> int:
    ...
    require(status["installed_equipment_item_count"] == 57 and not status["tether_first_equipment_configuration"] and status["tether_development_interface_retained"] and status["onboard_energy_candidate_geometry_present"] and not status["onboard_energy_installed"], "installed-equipment configuration boundary drift")
