...
def main() -> int:
    ...
    print(f"PASS: HR-30 whole-body P0.1 has 25-DOF URDF/MJCF, five articulated S2-S5 pose candidates, 56 located equipment/harness items including a dimensioned onboard-energy candidate, and {reconciled_mass:.3f} kg planning mass plus budgets, BOM, hands, walking, agent and build artifacts; the 12 kg P0.1 envelope is provisional, the 10 kg stretch objective is missed, and validation/all work authority remain false")
    return 0
