...
def main() -> int:
    ...
    require(all("B03B-PASK-1" in r["controller_side_connector_and_pin_mapping"] and "NO VDD" in r["controller_side_connector_and_pin_mapping"] for r in rs), "RS-485 controller-side JST PA data-only connector candidate missing")
    require(all("B02B-PASK-1" in r["controller_side_connector_and_pin_mapping"] and "NO VDD" in r["controller_side_connector_and_pin_mapping"] for r in ttl), "TTL controller-side JST PA data-only connector candidate missing")
