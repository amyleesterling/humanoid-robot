...
def main() -> int:
    try:
        ...
        if not governance or governance["identifier"] != "HR-V0-GOV-P0.2" or "not_approved" not in governance["release_state"]:
            fail("release candidate does not bind fail-closed P0.2 governance control")
