"""Generate the review-only DXL-STAR-P0.1 manufacturing evidence package.
...
def main() -> None:
    ...
    project_path = SOURCE / "hr-v0-dxl-star.kicad_pro"
    ...
    if OUT.exists():
        ...
        if resolved.parent != expected_parent or resolved.name != "dxl-star-manufacturing-p0.1":
    ...
    write_text_lf(OUT / "position-transform.json", json.dumps({
        ...
        "comparison": "native DXL-STAR-P0.1 footprint centers and rotations",
        "reference_count": 7,
    ...
    inputs = [
        ("DXL-MFG-IN-001", "native board identity", "DXL-STAR-P0.1", "SOURCE BOUND"),
