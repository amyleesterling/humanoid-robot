...
def main() -> int:
    ...
    files_data = [
        ...
        ("PCBA-FILE-005","assembly BOM","exact board-only BOM with MPN and approved sourcing route","NOT RELEASED"),
        ("PCBA-FILE-006","centroid/XYRS","derived only after assembler convention is accepted","NOT RELEASED"),
        ("PCBA-FILE-007","assembly drawing","top/bottom polarity, orientation, special process and DNP notes","NOT RELEASED"),
    ...
    holds_data = [
        ...
        ("PCBA-HOLD-012","supplier data package","OPEN","hash-bound current CAM/BOM/centroid/drawings/traveler generated only after prior holds close"),
