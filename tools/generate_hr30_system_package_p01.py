...
def joint_rows() -> list[dict]:
    ...
    for side, sign in (("L", 1.0), ("R", -1.0)):
        rows.extend([
            ...
            {"name": f"{side}_GRIPPER", "parent": f"{side}_hand", "child": f"{side}_gripper", "type": "prismatic", "axis": (sign, 0, 0), "limit": (0.0, 0.026, 0.03)},
...
def write_budgets_and_bom() -> None:
    ...
    compute = [
        ...
        ("Actuator buses", "five RS-485 plus three TTL half-duplex segments", 8, "RS-485: legs, proximal arms, waist; TTL: head and distal hands", "exact transceivers, pins, termination/bias, level shifting, protection, shield/return and data-only harnesses SELECTION REQUIRED"),
    ]
...
<section><h2>System artifacts</h2><div class="panel"><p><a href="hr30.urdf">URDF</a> · <a href="hr30.xml">MJCF</a> · <a href="mass-properties-budget.csv">Mass/COM/inertia</a> · <a href="power-energy-budget.csv">Power/energy</a> · <a href="thermal-budget.csv">Thermal</a> · <a href="compute-sensor-network-budget.csv">Compute/sensors/network</a> · <a href="actuator-bus-topology.csv">Actuator bus topology</a> · <a href="actuator-bus-axis-binding.csv">All-axis bus binding</a> · <a href="whole-body-electrical-integration.md">Electrical integration</a> · <a href="cost-budget.csv">Cost</a> · <a href="whole-robot-candidate-bom.csv">Whole-robot BOM</a> · <a href="gripper-functional-specification.md">Hands</a> · <a href="walking-development-architecture.md">Walking</a> · <a href="embodied-agent-architecture.md">OpenAI/local-control boundary</a> · <a href="structured-action-request.schema.json">Action schema</a> · <a href="modular-fabrication-assembly-electrification-plan.md">Build/electrification plan</a> · <a href="HR-30_modular_fabrication_candidate.step">Fabrication-candidate STEP</a> · <a href="fabrication-part-register.csv">Part register</a> · <a href="service-panel-interface-register.csv">Service panels</a> · <a href="harness-route-register.csv">Harness routes</a></p></div></section>
