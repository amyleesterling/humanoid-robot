...
def instrument_records() -> list[dict]:
    return [
        ...
        {"instrument_id":"INS-05","role":"reserved digital event capture","manufacturer":"NI","model":"NI-9401","order_code":"779351-01","quantity":1,"acquisition":"BORROW/RENT PREFERRED; PURCHASE NOT RELEASED","verified_capability":"8 bidirectional 5 V TTL channels; 100 ns propagation; no channel-to-channel isolation","calibration_state":"SELF-TEST AND KNOWN-PULSE CHECK REQUIRED","connection_state":"PROHIBITED UNTIL ISOLATED 24 V-TO-TTL INTERFACE IS SELECTED/VERIFIED","warning":WARNING},
...
def channel_records() -> list[dict]:
    channels = [
        ...
        ("CH-AI-03","INS-02/AI2","TTL_SELECTED_SAFE_9V","one selected 9 V bus at a time","differential voltage","+/-60 V","50 kS/s","E2-E7"),
        ("CH-AI-04","INS-02/AI3","CTRL_SAFE_5V","logic/control rail","differential voltage","+/-60 V","50 kS/s","E1-E7"),
        ("CH-AI-05","INS-03/AI0","ESTOP_CH_A_24V","E-stop channel A diagnostic voltage","differential voltage","+/-60 V","50 kS/s","E3-E7"),
        ("CH-AI-06","INS-03/AI1","WATCHDOG_PERMIT_24V","diagnostic permit voltage","differential voltage","+/-60 V","50 kS/s","E3-E7"),
        ("CH-AI-07","INS-03/AI2","K1_COIL_OR_MIRROR_24V","K1 selected diagnostic point","differential voltage","+/-60 V","50 kS/s","E3-E7"),
        ("CH-AI-08","INS-03/AI3","K2_COIL_OR_MIRROR_24V","K2 selected diagnostic point","differential voltage","+/-60 V","50 kS/s","E3-E7"),
        ...
        ("CH-DIO-01","INS-05/DIO0","TIME_ZERO_ISOLATED_TTL","optional common event pulse","5 V TTL","0-5.25 V max","hardware timed","E0-E7"),
...
def abort_records() -> list[dict]:
    return [
        ...
        {"limit_id":"AL-03","signal":"TTL_SELECTED_SAFE_9V","equipment_boundary":"Pololu S18V20F9 candidate fixed 9 V; XC330 accepts 6.5-12.0 V","provisional_observation":"flag outside 8.7-9.3 V only as an engineering review band","automatic_trip":"NONE DEFINED","qualified_limit":"SELECTION REQUIRED","action":"remove source; do not connect actuator until converter/load validation closes","status":"OPEN - NOT RELEASED","warning":WARNING},
        {"limit_id":"AL-04","signal":"CTRL_SAFE_5V","equipment_boundary":"exact final compute/control converter and loads unresolved","provisional_observation":"NONE - equipment-specific window missing","automatic_trip":"NONE DEFINED","qualified_limit":"SELECTION REQUIRED","action":"remove logic source on unexpected behavior or qualified-sheet excursion","status":"OPEN - NOT RELEASED","warning":WARNING},
