...
PINS = [
    ...
    ("CIPIN-005", "JWH1", "1", "isolated heartbeat input", "PI_HEARTBEAT", "PCB-P0.7 exact connector allocation", "Harness connector, contacts, wire and retention remain open"),
    ("CIPIN-006", "JWH1", "2", "compute-domain return", "COMPUTE_0V", "PCB-P0.7 exact connector allocation", "Harness connector, contacts, wire and retention remain open"),
    ("CIPIN-007", "TP15", "1", "watchdog SWDIO test access", "WD_SWDIO", "PCB-P0.7 exact rectangular Harwin test point", "Unpowered fixture and programmer selection required"),
    ("CIPIN-008", "TP16", "1", "watchdog SWCLK test access", "WD_SWCLK", "PCB-P0.7 exact rectangular Harwin test point", "Unpowered fixture and programmer selection required"),
    ("CIPIN-009", "TP2", "1", "watchdog debug return", "SAFETY_0V", "PCB-P0.7 exact rectangular Harwin test point", "Unpowered fixture and no-back-power proof required"),
]
...
SOURCES = [
    ...
    ("CISRC-006", "Project Button watchdog PCB-P0.7 source and checker", "PCB-P0.7 / HR-V0-WD-PCBA-RFI-P0.1", "repository state 2026-08-09", "../../kicad/project-button-v3/project-button-v3.kicad_pcb", "Exact TP2/TP15/TP16 net allocation and rectangular Harwin footprint; no current CAM, fabricated board or installed access evidence"),
]
