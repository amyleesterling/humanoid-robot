...
def main():
    ...
    if current_handoff.startswith(("R282 J2 refinement erratum:", "R283 J2 execution architecture:")) and any(text in current_readme for text in ("Two hundred eighty-two rounds are complete", "Two hundred eighty-three rounds are complete")):
