...
def main() -> int:
    ...
    need(electrical.get("configuration_reconciliation") == "HR-V0-CONFIG-REC-P0.5", "R241 configuration reconciliation missing")
    ...
    need(electrical.get("release_state") == "p115_current_p118_p119_p120_p121_unaccepted_r241_exact_duct_candidate_junction_conductor_fill_physical_qualified_and_authority_open", "electrical release state changed")
