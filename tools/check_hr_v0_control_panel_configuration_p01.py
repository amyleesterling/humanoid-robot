...
def main() -> int:
    ...
    need(electrical.get("configuration_reconciliation") == "HR-V0-CONFIG-REC-P0.7", "R243 configuration reconciliation missing")
    ...
    need(electrical.get("release_state") == "p115_current_p121_unaccepted_r243_exact_termination_candidates_only_received_application_calibration_physical_qualified_and_authority_open", "electrical release state changed")
