...
def main() -> int:
    ...
    need(electrical.get("release_state") == "p115_current_p118_p119_p120_p121_unaccepted_r235_application_evidence_route_complete_all_questions_unsent_tests_unexecuted_manufacturer_qualified_and_authority_open", "electrical release state changed")
