...
def main() -> int:
    ...
    need(electrical.get("configuration_reconciliation") == "HR-V0-CONFIG-REC-P0.6", "R242 configuration reconciliation missing")
    ...
    need(electrical.get("release_state") == "p115_current_p118_p119_p120_p121_unaccepted_r242_exact_conductor_candidate_geometry_fill_only_color_dcr_cut_protection_thermal_physical_qualified_and_authority_open", "electrical release state changed")
