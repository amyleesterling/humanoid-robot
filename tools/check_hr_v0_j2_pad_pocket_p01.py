...
def main() -> int:
    ...
    need((ROOT / "docs/handoff-current.md").read_text(encoding="utf-8").startswith("R277 J2 pad-pocket correction:"), "handoff drift")
    need((ROOT / "docs/review-ledger.md").read_text(encoding="utf-8").count("| R277 |") == 1, "ledger missing or duplicated")
    need("Two hundred seventy-seven rounds are complete" in (ROOT / "README.md").read_text(encoding="utf-8"), "README count drift")
