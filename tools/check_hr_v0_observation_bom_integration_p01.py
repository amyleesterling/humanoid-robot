...
def main() -> int:
    ...
    if bill.get("system_group_count", 0) < 108 or bill.get("configuration_reconciliation") not in {gen.CID, "HR-V0-CONFIG-REC-P0.24", "HR-V0-CONFIG-REC-P0.25", "HR-V0-CONFIG-REC-P0.26", "HR-V0-CONFIG-REC-P0.27", "HR-V0-CONFIG-REC-P0.28", "HR-V0-CONFIG-REC-P0.29"} or bill.get("observation_bom_integration") != gen.ID or gen.ID not in bill.get("supporting_identifiers", []):
        errors.append("release BOM metadata is stale")
    if electrical.get("configuration_reconciliation") not in {gen.CID, "HR-V0-CONFIG-REC-P0.24", "HR-V0-CONFIG-REC-P0.25", "HR-V0-CONFIG-REC-P0.26", "HR-V0-CONFIG-REC-P0.27", "HR-V0-CONFIG-REC-P0.28", "HR-V0-CONFIG-REC-P0.29"} or electrical.get("observation_bom_integration") != gen.ID:
