...
def main() -> int:
    ...
    for domain in ("electrical", "bill_of_materials", "assembly"):
        ...
        if not product or product.get("configuration_reconciliation") not in {CID, "HR-V0-CONFIG-REC-P0.26", "HR-V0-CONFIG-REC-P0.27", "HR-V0-CONFIG-REC-P0.28", "HR-V0-CONFIG-REC-P0.29", "HR-V0-CONFIG-REC-P0.30", "HR-V0-CONFIG-REC-P0.31"} or product.get("u2d2_jc1_harness") != ID:
