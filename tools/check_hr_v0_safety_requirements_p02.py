...
def main() -> int:
    ...
    need(safety.get("release_state") == "r232_separate_sra1_input_return_interlocks_source_proved_zero_safety_credit_common_cause_physical_validation_plr_sil_and_qualified_review_open", "release safety state changed")
