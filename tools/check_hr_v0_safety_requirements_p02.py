...
def main() -> int:
    ...
    need(safety.get("release_state") == "r225_two_series_ordinary_watchdog_contacts_source_proved_zero_safety_credit_common_cause_physical_validation_plr_sil_and_qualified_review_open", "release safety state changed")
