...
def integrate(bindings: list[dict[str, str]]) -> None:
    ...
    updates = {
        ...
        "HR30-P01-H10": "Whole-body, module and actual-axis geometry includes individual files for 98 body/frame/hand parts and 64 real current joint shaft/carrier solids. All 39 legacy pulley/coupler envelopes have bound successors and are marked DO NOT FABRICATE. No successor is selected for procurement or released for fabrication; drawings, fits, materials/processes, exact hardware, DFM, FAI, proof, physical test and qualified review remain open.",
    }
    for row in holds:
