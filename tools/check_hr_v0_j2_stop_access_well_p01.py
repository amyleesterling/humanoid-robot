...
def main() -> int:
    ...
    need((ROOT / "docs/handoff-current.md").read_text(encoding="utf-8").startswith("R273 access-well J2 stop candidate:"), "handoff")
    need("| R273 |" in (ROOT / "docs/review-ledger.md").read_text(encoding="utf-8"), "ledger")
    need("Two hundred seventy-three rounds are complete: R01-R273." in (ROOT / "README.md").read_text(encoding="utf-8"), "README count")
