...
def main() -> int:
    ...
    need(any(text in (ROOT / "README.md").read_text(encoding="utf-8") for text in ("Two hundred seventy-six rounds are complete: R01-R276.", "Two hundred seventy-seven rounds are complete: R01-R277.", "Two hundred seventy-eight rounds are complete: R01-R278.", "Two hundred seventy-nine rounds are complete: R01-R279.")), "README count")
