...
def main() -> int:
    ...
    need((ROOT / "docs/handoff-current.md").read_text(encoding="utf-8").startswith(("R273 access-well J2 stop candidate:", "R274 A04 exact-candidate joint package:", "R275 J2 soft-contact pad boundary:", "R276 exact-contact J2 pad correction:", "R277 J2 pad-pocket correction:", "R278 exact-normal J2 stop correction:", "R279 J2 convergence protocol:", "R280 J2 refinement execution feasibility:", "R281 J2 numerical backend:", "R282 J2 refinement erratum:", "R283 J2 execution architecture:", "R284 C07 curved-mesh development:", "R285 targeted C07 remesh:")), "handoff")
    need("| R273 |" in (ROOT / "docs/review-ledger.md").read_text(encoding="utf-8"), "ledger")
    need(any(text in (ROOT / "README.md").read_text(encoding="utf-8") for text in ("Two hundred seventy-six rounds are complete: R01-R276.", "Two hundred seventy-seven rounds are complete: R01-R277.", "Two hundred seventy-eight rounds are complete: R01-R278.", "Two hundred seventy-nine rounds are complete: R01-R279.", "Two hundred eighty rounds are complete: R01-R280.", "Two hundred eighty-one rounds are complete: R01-R281.", "Two hundred eighty-two rounds are complete: R01-R282.", "Two hundred eighty-three rounds are complete: R01-R283.", "Two hundred eighty-four rounds are complete: R01-R284.", "Two hundred eighty-five rounds are complete: R01-R285.")), "README count")
