...
def main() -> None:
    ...
    if bom_product.get("supporting_identifiers") != ["EVALUATION-BATCH-A", "HR-V0-MECH-EVAL-P0.1", "HR-V0-EVAL-BATCH-A-ACQ-P0.1", "HR-V0-EVAL-BATCH-A-RCV-P0.1", "HR-V0-ACT-AC-CORD-P0.1", "HR-V0-MECH-BOM-BIND-P0.2", "HR-V0-WD-BOM-BIND-P0.1", "DXL-STAR-P0.2-CARRIER-CANDIDATE", "HR-V0-DXL-STAR-MFG-P0.2", "HR-V0-DXL-INJECT-BIND-P0.1", "HR-V0-DXL-HARNESS-ALLOC-P0.1", "HR-V0-DXL-PROT-CARRIER-P0.3", "HR-V0-DXL-PROT-CARRIER-HARNESS-P0.1", "HR-V0-DXL-CARRIER-INTEGRATION-P0.1", "HR-V0-CONFIG-REC-P0.3", "HR-V0-PANEL-NODE-PLACEMENT-P0.1", "HR-V0-CONFIG-REC-P0.4", "HR-V0-P121-SEGREGATION-HW-P0.1", "HR-V0-CONFIG-REC-P0.5", "HR-V0-P121-CONDUCTOR-FILL-P0.1", "HR-V0-CONFIG-REC-P0.6", "HR-V0-P121-TERM-P0.1", "HR-V0-CONFIG-REC-P0.7", "HR-V0-CONFIG-REC-P0.8", "HR-V0-XT1-P0.1", "HR-V0-LABEL-P0.1", "HR-V0-COMPUTE-STORAGE-P0.2", "HR-V0-LOT-A-SRC-P0.1"] or bom_product.get("release_state") != (
        "r244_98_group_bom_unchanged_with_nominal_dcr_drop_evidence_exact_p121_ferrule_candidates_held_and_lot_a_purchase_blocker_no_complete_machine_procurement_release"
    ) or bom_product.get("system_group_count") != 98 or bom_product.get("configuration_reconciliation") != "HR-V0-CONFIG-REC-P0.8" or bom_product.get("p121_segregation_hardware") != "HR-V0-P121-SEGREGATION-HW-P0.1" or bom_product.get("p121_conductor_fill") != "HR-V0-P121-CONDUCTOR-FILL-P0.1" or bom_product.get("p121_termination") != "HR-V0-P121-TERM-P0.1" or bom_product.get("lot_a_source_reconciliation") != "HR-V0-LOT-A-SRC-P0.1" or "HR-V0-LOT-A-SRC-P0.1" not in bom_product.get("supporting_identifiers", []):
    ...
    if assembly_product.get("supporting_identifiers") != ["HR-V0-ARM-ARCH-P0.8-DWG-INTEGRATED-CANDIDATE", "Project Button Electrical V3-P1.15-CARRIER-CANDIDATE", "HR-V0-E2-SEQ-P0.1", "HR-V0-GOV-P0.3", "HR-V0-CONFIG-REC-P0.3", "HR-V0-CONFIG-REC-P0.4", "HR-V0-CONFIG-REC-P0.5", "HR-V0-CONFIG-REC-P0.6", "HR-V0-CONFIG-REC-P0.7", "HR-V0-CONFIG-REC-P0.8", "HR-V0-MECH-BOM-BIND-P0.2"] or assembly_product.get("release_state") != (
