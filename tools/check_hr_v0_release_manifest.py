...
def main() -> None:
    ...
    if safety_product.get("supporting_identifiers") != ["DF-01 ZERO SAFETY CREDIT", "HR-V0-WD-SUPPLY-P0.1", "HR-V0-POWERLOSS-P0.1", "HR-V0-PASSIVE-ARM-RECEIVER-P0.1", "HR-V0-PASSIVE-ARM-RECEIVER-VERIFY-P0.1", "HR-V0-PASSIVE-ARM-RECEIVER-DETAIL-P0.2", "HR-V0-RECEIVER-GUIDE-IF-P0.1", "HR-V0-SRS-P0.2", "HR-V0-FS-REVIEW-ROUTE-P0.1", "HR-V0-WD-PERMIT-TOPOLOGY-P0.1", "HR-V0-P120-WD-INTERLOCK-P0.1"] or safety_product.get("release_state") != "r232_separate_sra1_input_return_interlocks_source_proved_zero_safety_credit_common_cause_physical_validation_plr_sil_and_qualified_review_open" or safety_product.get("watchdog_permit_topology_proof") != "HR-V0-WD-PERMIT-TOPOLOGY-P0.1" or safety_product.get("watchdog_interlock_candidate") != "HR-V0-P120-WD-INTERLOCK-P0.1":
