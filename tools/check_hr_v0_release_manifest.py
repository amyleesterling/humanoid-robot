...
def main() -> None:
    ...
    electrical_product = next(
        (item for item in products if isinstance(item, dict) and item.get("identifier") == "Project Button Electrical V3-P1.8"),
        {},
    )
    ...
    if firmware_product.get("supporting_identifiers") != [
        ...
        errors.append("HR-V0-FW-P0.2 supporting identifiers or fail-closed release state changed")
