...
def main() -> None:
    ...
    if instrumentation_product.get("supporting_identifiers") != ["HR-V0-DYN-CHAR-P0.1", "HR-V0-DYN-TRACE-P0.1", "EG-025", "EG-026"] or instrumentation_product.get("release_state") != (
