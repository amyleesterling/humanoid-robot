...
CONFIG = [
    ...
    ("E2-CFG-011", "WDPCB1", "Project Button PCB-P0.6 / HR-V0-WD-LAND-P0.1", "INSTALL CANDIDATE", "CONTROL ONLY", "No current CAM release; assembler/supplier acceptance, new CAM review, fabrication, bare-board, assembly, HIL, fault, EMC and thermal evidence required."),
...
HOLDS = [
    ...
    ("E2-HOLD-008", "WATCHDOG PCB", "PCB-P0.6 has no CAM or manufacturing release; R88 PCB-P0.5 CAM is superseded", "Assembler/supplier acceptance, land/process review, new fabrication package, bare-board test, assembly, HIL/fault/EMC/thermal evidence"),
