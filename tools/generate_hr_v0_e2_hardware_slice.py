...
CONFIG = [
    ...
    ("E2-CFG-011", "WDPCB1", "Project Button PCB-P0.5", "INSTALL CANDIDATE", "CONTROL ONLY", "No Gerber/drill release; fabrication, bare-board, assembly, HIL, fault, EMC and thermal evidence required."),
