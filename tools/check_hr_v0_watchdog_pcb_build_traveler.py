...
def main() -> int:
    ...
    if not hold8 or "PCB-P0.7" not in hold8["open_item"] or "internal R133 BOM/placement review data" not in hold8["open_item"] or "no assembler-normalized XYRS, CAM or manufacturing release" not in hold8["open_item"] or "PCB-P0.5 CAM" not in hold8["open_item"]:
    ...
    print("  Historical PCB-P0.5 route only; E2-HOLD-008 points to PCB-P0.7 with internal R133 review data but no machine XYRS or current CAM")
