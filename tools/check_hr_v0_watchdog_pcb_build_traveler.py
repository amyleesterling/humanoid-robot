...
def main() -> int:
    ...
    if not hold8 or "CAM review candidate" not in hold8["open_item"] or "no manufacturing release" not in hold8["open_item"]:
    ...
    print("  E2-HOLD-008 remains open; fabrication and energization remain prohibited")
    return 0
