...
def main() -> None:
    ...
    need((ROOT/"docs/handoff-current.md").read_text(encoding="utf-8").startswith(("R268 functional datum/GD&T correction:","R269 J2 hard-stop strength correction:","R270 corrected J2 contact/load model:","R271 C06 full-part FEA rejection screen:")),"handoff")
