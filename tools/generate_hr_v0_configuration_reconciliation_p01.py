...
def main() -> None:
    ...
    for directory in (ENG, OUT):
        ...
        status = {
            "identifier": "HR-V0-CONFIG-REC-P0.1", "round": "R163+R164-SYNCHRONIZED", "date": "2026-08-09",
            "current_electrical_identifier": "Project Button Electrical V3-P1.15-CARRIER-CANDIDATE",
            "system_bom_groups": 91, "current_records": 9, "supersession_records": 5,
