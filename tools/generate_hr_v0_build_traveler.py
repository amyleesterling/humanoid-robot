...
SOURCES = {
    ...
    "mechanical_release": ROOT / "docs/hr-v0-arm-architecture-p0.8-dwg-integrated.md",
    "mechanical_binding": ROOT / "bom/hr-v0-mechanical-custom-part-binding-p0.2.csv",
    "mechanical_configuration": ROOT / "configuration/hr-v0-config-reconciliation-p0.3/package-status.json",
...
STEP_GROUPS = {
    ...
    "BT-P07": [
        ("Install only accepted custom parts and exact received ROBOTIS interfaces.", "mechanical_release|mechanical_binding|mechanical_configuration|joint_metrology|mechanical_dfm", "part identity signoff"),
